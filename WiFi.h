...
char* ssid = "FullHouse_2.4";
char* password = "nichtnurfuchssein,auchschwanzmussmanhaben!1!!";

#define HOSTNAME "LED-Matrix" ///< Hostname. The initializeWiFi function adds the Chip ID at the end.
